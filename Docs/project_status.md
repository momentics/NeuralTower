...
- Реализован GPU Health Check (startup) и GPU Watchdog (фоновый): проверка наличия всех 4 GPU перед запуском vLLM/SGLang и непрерывный мониторинг с автоматическим плавным завершением рабочих контейнеров при потере любого GPU.
