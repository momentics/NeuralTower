...
- Реализован GPU Health Check (startup) и GPU Watchdog (фоновый): проверка наличия всех 4 GPU перед запуском vLLM/SGLang и непрерывный мониторинг с автоматическим graceful shutdown workload-контейнеров при потере любого GPU.
