...
Это позволило сохранить чистоту вычислительного отсека и обеспечить кратчайший путь для воздушных потоков. Питание системы — это еще один отдельный квест. Два блока Corsair HX1000 (по 1 кВт каждый, суммарно 2 кВт с запасом для пиковых нагрузок 1,4 кВт) пришлось синхронизировать и объединить их корпуса через алюминиевую раму, чтобы избежать разности потенциалов. Профиль 2020 в данном случае служит не просто скелетом, а единой шиной заземления, минимизирующей наводки на высокочастотных линиях передачи данных.
