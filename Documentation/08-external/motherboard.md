...
- **Максимальная конфигурация:** 1 процессор
...
| Каналы | 4-канальный |
| Группы | DIMM_A1–A4 / DIMM_B1–B4 |

## 4. Слоты расширения

| Слот | Тип | Линии |
|---|---|---|
| PCIEX16_1 | PCIe 3.0 x16 | x16 (от CPU) |
...
Плата оснащена двумя чипами PLX PEX 8747, каждый из которых мультиплексирует линии PCIe от единственного CPU для обеспечения дополнительных слотов x16:
- **PLX1:** PCIEX16_1, PCIEX16_2, PCIEX16_3, PCIEX16_4
- **PLX2:** PCIEX16_5, PCIEX16_6, PCIEX16_7
...
| CPU 8-pin (EPS) | Питание процессора (основное) |
| CPU 8-pin (EPS) | Питание процессора (дополнительное) |
